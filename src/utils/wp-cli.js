...
async function setupWordPress(projectPath, dbName, pathSystem) {
  ...
  try {
    ...
    execSync(
      `wp config create --path=${pathSystem}/system --dbname=${dbName} --dbuser=wordpress --dbpass=wordpress --dbhost=172.19.0.5 --dbcharset=utf8mb4 --dbcollate=utf8mb4_unicode_ci --extra-php <<PHP
